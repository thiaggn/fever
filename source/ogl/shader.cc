...
gl_shader::gl_shader(gl_shader_type type, const char *path) {
...
int gl_shader::compilation_succeded(uint shader) {
    int success;
    ...
    if (!success) {
        ...
        fprintf(stderr, "error: gl_program::add: failed to compile shader.\n");
